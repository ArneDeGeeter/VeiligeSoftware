        ...
        match &map {
            Some(m) => {
                unsafe {
                    ...
                    io.gpio_set_bits_ = (io.gpio_port_ + 0x1C as *mut u32) as *mut u32;
                    io.gpio_clr_bits_ = (io.gpio_port_ + 0x28 as *mut u32) as *mut u32;
                    io.gpio_read_bits_ = (io.gpio_port_ + 0x34 as *mut u32) as *mut u32;
